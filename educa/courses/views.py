...
from .models import Course, Subject, Portfolio
from django.contrib.auth.mixins import (LoginRequiredMixin, PermissionRequiredMixin)
from django.shortcuts import get_object_or_404, redirect
from django.views.generic.base import TemplateResponseMixin, View
from .forms import ModuleFormSet, PortfolioForm
...
@login_required
def add_portfolio(request, course_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            portfolio.save()
            create_action(request.user, 'created', portfolio)
            return redirect('view_portfolio', course_id=course.id)  
    else:
        form = PortfolioForm()
    return render(request, 'courses/portfolio/add.html', {'form': form, 'course': course})

@login_required
def view_portfolio(request, course_id):
    course = get_object_or_404(Course, id=course_id)
    ...
    return render(request, 'courses/portfolio/view.html', {'portfolios': portfolios, 'course': course})